...
A `HarmonicEquation` no longer has to come from a second-order `DifferentialEquation`. It can
now be derived from, for example, `QuantumCumulants.MeanfieldEquations`. Getting there changed
